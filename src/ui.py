...
class UI:
    ...
    def show_bar(self,current,max_amount,bg_rect,colour):
        ...
        pygame.draw.rect(self.display_surface,UI_BOARDER_COLOUR,bg_rect,3)
    ...
    def show_exp(self,exp):
        ...
        pygame.draw.rect(self.display_surface,UI_BOARDER_COLOUR,text_rect.inflate(20,20),3)

    def selection_box(self,left,top,has_switched):
        bg_rect = pygame.Rect(left,top,ITEM_BOX_SIZE,ITEM_BOX_SIZE)
        pygame.draw.rect(self.display_surface,UI_BG_COLOUR,bg_rect)
        if has_switched:
            pygame.draw.rect(self.display_surface,UI_BOARDER_COLOUR_ACTIVE,bg_rect,3)
        else:
            pygame.draw.rect(self.display_surface,UI_BOARDER_COLOUR,bg_rect,3)
        return bg_rect
    ...
    def magic_overlay(self,magic_index,has_switched):
        bg_rect = self.selection_box(10,540,has_switched) 
